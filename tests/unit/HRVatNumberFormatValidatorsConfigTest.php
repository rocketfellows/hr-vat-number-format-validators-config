...
namespace rocketfellows\HRVatNumberFormatValidatorsConfig\tests\unit;
...
use rocketfellows\HRVatNumberFormatValidatorsConfig\HRVatNumberFormatValidatorsConfig;

class HRVatNumberFormatValidatorsConfigTest extends TestCase
{
    private const TESTING_CONFIG_CLASS = HRVatNumberFormatValidatorsConfig::class;
    private const EXPECTED_CONFIG_DEFAULT_VALIDATOR_CLASS = HRVatFormatValidator::class;
    ...
    {
        $this->assertEquals(ISO3166::HR(), $config->getCountry());
    }
